  ...
  public   class User
    {
            ...
            )
        {
            ...
            {
                throw new ArgumentException("Невозможная дата рожения", nameof(birthDate));
            ...
            if(height<=0)
            {
                throw new ArgumentException("Рост не может быть больше или равен нулю", nameof(height));
